...
<main class="container">
  <header>
    <h1>Bonjour Olivier et Raphael ! 😊</h1> 
    <p>Le but de l'exercice était de nous faire manipuler un peu de <strong>HTML</strong> de <strong>JS</strong>, de <strong>PHP</strong> et de faire la liaison avec la base de données <strong>MySQL</strong>.</p>
    <p>Je vois déjà des visages se crisper... 😁(même pas haha !!)
       ... pas de panique ! L'intégralité du code est commenté, comme une visite guidée à travers le code, pour vous aider dans cette tâche. Et puis vous verrez, que finalement, ce n'est pas si compliqué que ça. Vous pourriez même y prendre goût par accident 😁</p>
  </header>
  
  <section id="exemple">
    <h2>Merci pour ces deux semaines intenses ! C'était super !✨</h2>
    <p>
